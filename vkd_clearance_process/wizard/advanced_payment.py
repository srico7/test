...
class AdvancedPayment(models.TransientModel):
    _name = 'advanced.payment'
    _description = 'Advanced Payment'
    ...
    def action_confirm_advanced_payment(self):
        vals = {
            ...
            'ref': self.note,
            'clearance_sale_order_id': self.sale_order_id.id,
        }
